define(["jquery", "underscore", "webuploader", "jquery.jplayer", "bootstrap"],
function(a, b, c) {
    var d = {
        defaultoptions: {
            direct: !1,
        ...
        initRemote: function() {
            ...
            b.modalobj.find(".btn-primary").click(function() {
                ...
                c.length > 0 && a.getJSON("./index.php?m=Admin&c=FileUpload&a=fetch", {
                    url: c
                },
                function(a) {
        ...
        localPage: function(c) {
            ...
            return a.getJSON("./index.php?m=Admin&c=FileUpload&a=local", {
                page: c,
                year: e,
                month: f
            },
            function(c) {
                ...
                b.isEmpty(c.items) ? g.find(".history-content").css("text-align", "center").html('<i class="fa fa-info-circle"></i> 暂无数据') : (g.data("attachment", c.items), g.find(".history-content").empty(), g.find(".history-content").html(b.template(d.buildHtml().localDialogLi)(c)), g.find("#image-list-pager").html(c.page), g.find(".pagination a").click(function() {
                    ...
                    var b = a(this),
                    c = a(this).data("id");
                    return c ? (a.post("./index.php?m=Admin&c=FileUpload&a=delete", {
                        id: c
                    },
                    function(a) {
        ...
        localAudioPage: function(c) {
            ...
            return a.getJSON("./index.php?m=Admin&c=FileUpload&a=local&type=audio&pagesize=5", {
                page: c
            },
            function(c) {
                c = c.message,
            ...
            a(".audio-player-play").click(function() {
                ...
                if (b) {
                    ...
                    d.jPlayer({
                        ...
                        swfPath: "Public/components/jplayer",
        ...
        initImageUploader: function() {
            function b(b) {
                ...
                "invalid" === b.getStatus() ? j(b.statusText) : (g.text("预览中"), d.makeThumb(b,
                function(b, c) {
                ...
                if (a !== state) {
                    ...
                    case "finish":
                        if (n.removeClass("disabled"), b = d.getStats(), b.successNum) {
                            if (d.uploadedFiles.length > 0) return i.finish(d.uploadedFiles),
            ...
            var q = {
                ...
                dnd: "#dndArea",
                paste: "#uploader",
                swf: "./Public/componets/webuploader/Uploader.swf",
                server: "./index.php?m=Admin&c=FileUpload&a=upload&type=image",
                chunked: !1,
                compress: !1,
                accept: {
                    title: "Images",
        ...
        initAudioUploader: function() {
            ...
            var q = {
                ...
                paste: "#uploader",
                swf: "./Public/componets/webuploader/Uploader.swf",
                server: "./index.php?m=Admin&c=FileUpload&a=upload&type=audio",
                chunked: !1,
                compress: !1,
                accept: {
                    title: "Audios",
