/**
 * @author Lin参考Beginner navbar.js并进行改进
...
layui.define(['jquery','layer','element','common'],function(exports){
    ...
    Navbar.prototype.cleanCached = function(){
      ...
      * @return    {[type]}                      [返回Html字符串]<i class="layui-icon">&#xe611;</i>
      */
