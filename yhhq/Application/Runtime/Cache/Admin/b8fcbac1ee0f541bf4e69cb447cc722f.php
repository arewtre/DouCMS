        ...
        <div class="layui-field-box">
            ...
            <table class="layui-table" lay-even>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <!--<?php if($vo['is_display']==0): ?><span class="layui-btn confirm" data-info="你确定显示当前栏目么？" data-id="<?php echo ($vo['pid']); ?>" data-url="<?php echo U('open');?>">显示</span>                               
                                <?php else: ?>
                                <span class="layui-btn layui-btn-danger confirm" data-info="你确定隐藏当前栏目么？" data-id="<?php echo ($vo['pid']); ?>" data-url="<?php echo U('close');?>">隐藏</span><?php endif; ?>-->
                            <span class="layui-btn apii-add" data-url="<?php echo U('add', array('id' => $vo['pid']));?>"><i class="layui-icon">&#xe608;</i> 新增子栏目</span>
                            <span data-url="<?php echo U('edit', array('id' => $vo['pid']));?>" class="layui-btn edit layui-btn-normal">编辑</span>
                            <span class="layui-btn layui-btn-danger confirm" data-id="<?php echo ($vo['pid']); ?>" data-info="你确定删除当前栏目么？" data-url="<?php echo U('del');?>">删除</span>
                        </td>
