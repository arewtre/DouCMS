                    ...
                    columnDefs:[
                        ...
                        },
                        {
                            ...
                            "render":function(data, type, row){
                                ...
                                'data-id="' + row.art_id +'" data-info="你确定彻底删除当前文章？" data-url="<?php echo U('del');?>">彻底删除</span>';
                                returnStr += '<span class="layui-btn layui-btn-small confirm" ' +
                                    'data-id="' + row.art_id +'" data-info="你确定恢复当前文章？" data-url="<?php echo U('del');?>">恢复</span>';
                                return returnStr;
                            }
                        }
                    ],
