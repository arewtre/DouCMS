xiaoyu.fn.slide = function(options) {
	...
	function In_5(){
		...
		picLi.eq(index).find("a").show();
		setTimeout(function() {
			xiaoyu(".banner_bg5").stop().animate({opacity: 1},function(){
				setTimeout(function() {
					xiaoyu(".banner5_img1").stop().animate({"bottom":"0", "left":"460px", opacity: 1},800);
					setTimeout(function() {
						xiaoyu(".banner5_img2").stop().animate({"top":"118px", "left":"625px", opacity: 1},1000);
						setTimeout(function() {
							xiaoyu(".banner5_title").stop().animate({"top":"210px", "left":"938px", opacity: 1},800);
							setTimeout(function() {
								xiaoyu(".banner5_text1").stop().animate({"top":"340px", "left":"938px", opacity: 1},800);
								setTimeout(function() {
									xiaoyu(".banner5_text2").stop().animate({"top":"410px", "left":"938px", opacity: 1},800);
									setTimeout(function() {
										xiaoyu(".banner5_text3").stop().animate({"top":"470px", "left":"938px", opacity: 1},800,function(){
											lose = 0;
										});
									},150);
								},150);
	...
	function Out_5(){
		setTimeout(function() {
			xiaoyu(".banner5_img1").stop().animate({"bottom":"-150px", "left":"460px", opacity: 0},800);
			setTimeout(function() {
				xiaoyu(".banner5_img2").stop().animate({"top":"80px", "left":"625px", opacity: 0},1000);
				setTimeout(function() {
					xiaoyu(".banner5_title").stop().animate({"top":"210px", "left":"1238px", opacity: 0},800);
					setTimeout(function() {
						xiaoyu(".banner5_text1").stop().animate({"top":"340px", "left":"1238px", opacity: 0},800);
						setTimeout(function() {
							xiaoyu(".banner5_text2").stop().animate({"top":"410px", "left":"1238px", opacity: 0},800);
							setTimeout(function() {
								xiaoyu(".banner5_text3").stop().animate({"top":"470px", "left":"1238px", opacity: 0},800);
								xiaoyu(".banner_bg5").stop().animate({opacity: 0});
							},150);
						},150);
					},150);
				},150);
