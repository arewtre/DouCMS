...
<ul class="nav nav-tabs">
	...
	<li <?php  if($type == 'news' || $action == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo url('material/display/list', array('type' => 'news'));?>">图文</a></li>
</ul>
<?php  if($do == 'list') { ?>
		...
		<?php  if(is_array($lists)) { foreach($lists as $list) { ?>
			<div class="col-md-3">
				<div class="panel panel-default panel-image">
					<div class="panel-body">
						<div class="content">
							<img src="<?php  echo tomedia($list['attachment'], true);?>" width="100%" height="160" alt="<?php  echo $list['filename'];?>">
						...
						<div class="btn-group">
							...
							<a href="javascript:;" class="btn btn-default btn-sm btn-view" data-media-id="<?php  echo $list['media_id'];?>" data-type="<?php  echo $list['type'];?>">预览</a>
